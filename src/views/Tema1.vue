...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .container-100.mb-5.py-5(
      ...
      .d-flex.flex-wrap.align-items-center.col-lg-10.mx-auto
    ...
    .tarjeta--container.row.mb-5
      .col-md.tarjeta.color-primario.p-5(style="background-color: #E6F7FE")
      ...
      .col-md.tarjeta.color-primario.p-5(style="background-color: #A1EDF7")
        .row.justify-content-center.mb-4
          .col-6
            figure
    ...
    h3.mb-4 Principales mercados
    p.mb-5 Y dentro de los principales mercados se encuentran:
    ...
    .container-100.d-flex.flex-wrap.mb-5.align-items-center
      .col-lg-8.pe-lg-4
        ...
        p Ahora, hacer efectiva la implementación de mercados se da por dos razones:
    ...
    p.mb-5 El proceso de investigación de mercados se lleva a cabo mediante los siguientes pasos:
